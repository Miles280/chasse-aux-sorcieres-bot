...
@ApplyOptions<Subcommand.Options>({
	...
	subcommands: [
		...
		{ name: 'convert', chatInputRun: 'chatInputConvert' }
	]
})
export class BourseCommand extends Subcommand {
		...
		registry.registerChatInputCommand((builder) =>
			builder //
				...
				.addSubcommand((sub) =>
					sub // GIVE
						.setName('give')
						.setDescription('Donne une certaine quantité de ta monnaie à un membre.')
						.addUserOption((opt) =>
							opt //
								.setName('membre')
								.setDescription('Le membre concerné par cette action.')
				...
				.addSubcommand((sub) =>
					sub // CONVERT
						.setName('convert')
						.setDescription('Convertis tes gemmes en rubis.')
						.addNumberOption((opt) =>
							opt //
								.setName('valeur')
	...
	public async chatInputConvert(interaction: Subcommand.ChatInputCommandInteraction) {
